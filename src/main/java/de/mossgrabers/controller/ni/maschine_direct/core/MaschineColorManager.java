...
public class MaschineColorManager extends ColorManager
{
	...
	public static final int           BRIGHTNESS_ON       = 4;
	public static final int           BRIGHTNESS_HI       = 7;
    ...
    public MaschineColorManager ()
    {
        ...
        this.registerColorIndex (ColorManager.BUTTON_STATE_OFF, BRIGHTNESS_OFF);
        this.registerColorIndex (ColorManager.BUTTON_STATE_ON, BRIGHTNESS_ON);
        this.registerColorIndex (ColorManager.BUTTON_STATE_HI, BRIGHTNESS_HI);
