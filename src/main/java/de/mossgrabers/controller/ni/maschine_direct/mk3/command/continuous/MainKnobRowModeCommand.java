package de.mossgrabers.controller.ni.maschine_direct.mk3.command.continuous;
...
public class MainKnobRowModeCommand extends KnobRowModeCommand<MaschineControlSurface, MaschineConfiguration>
{
    ...
    {
		this.surface.getHost().println("Executing MainKnobRowModeCommand with value " + Integer.toString(value));
