 ...
 * Heavily influenced by librebellion: http://github.com/terminar/rebellion.
 *
 * @author Kate Temkin
 */
public class WindowsNIHostInterop extends AbstractNIHostInterop {
	...
	private class NotificationPipe {
	...
	void pollForNotifications() {
		...
		// Start an a read, attempting to fill our local buffer.
